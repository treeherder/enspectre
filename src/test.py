...
#enable Printer for debugging log   -- extremely resource thirsty, add delay loop
...
while True:
   ...
   if stroke == ord('q'):
      ...
      print ("resetting features to track")
      left_handle.begin()
      right_handle.begin()
      continue
   ##chassis methods   
   elif stroke == ord('a'):
      print ("rmoving base clockwise")
      chas.command('1')
      continue
   elif stroke == ord('d'):
      print ("moving base counterclockwise")
      chas.command('2')
      continue
